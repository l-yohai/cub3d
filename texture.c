...
/*   Updated: 2020/07/06 09:28:52 by yohlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_texture(t_info *info)
{
	...
	load_image(info, info->texture[1], info->south_texture_path, &img);
	load_image(info, info->texture[2], info->west_texture_path, &img);
	load_image(info, info->texture[3], info->east_texture_path, &img);
